...
seq_dir = r'/data/datasets/MSS_datasets/ISRUC/seq'
label_dir = r'/data/datasets/MSS_datasets/ISRUC/labels'
...
for psg_f_name, label_f_name in tqdm(psg_label_f_pairs):
    ...
    eeg_array = psg_array[:, 2:8]
    eog_array = psg_array[:, 0:2]
    ...
    print(psg_array.shape)
    psg_array = psg_array.reshape(-1, 30 * 100, 8)
    print(psg_array.shape)
    ...
    print(psg_array.shape)
    psg_array = psg_array.reshape(-1, 20, 30 * 100, 8)
