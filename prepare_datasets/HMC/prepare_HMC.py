...
seq_dir = r'/data/datasets/MSS_datasets/HMC/seq'
label_dir = r'/data/datasets/MSS_datasets/HMC/labels'
...
num_seqs = 0
num_labels = 0
signal_name = ['EEG F4-M1', 'EEG C4-M1', 'EEG O2-M1', 'EEG C3-M2', 'EOG E1-M2', 'EOG E2-M2']
for psg_f_name, label_f_name in tqdm(psg_label_f_pairs):
    ...
    epochs_array_ = epochs_array_.reshape(-1, 6)
    # std = StandardScaler()
    # epochs_array_ = std.fit_transform(epochs_array_)
    print(epochs_array_.shape)
    epochs_array_ = epochs_array_.reshape(-1, 3000, 6)
    epochs_array_ = epochs_array_.transpose(0, 2, 1)
    print(epochs_array_.shape)

    epochs_seq = epochs_array_.reshape(-1, 20, 6, 3000)
